...
public class Day04: BetterBaseDay
{
    ...
    public override ValueTask<string> Solve_2()
    {
        ...
        {
            cards[i].WinningNumbers.IntersectWith(cards[i].Numbers);
    ...
    private sealed class Card
    {
        ...
        public HashSet<string> WinningNumbers { get; set; }
        ...
        public Card(string line)
        {
            ...
            Number = int.Parse(split[0].Trim().Split(' ')[^1]);
            var numbers = split[1].Split('|');
            var splitNumbers = numbers[0].Trim().Split(' ');
            ...
            var winningSplitNumbers = numbers[1].Trim().Split(' ');
